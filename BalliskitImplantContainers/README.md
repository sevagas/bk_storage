...
This is the container for the Mythic C PIC implant; it is intended for use with the RedTeam DarwinOps tool. The container does not contain any implant code.
